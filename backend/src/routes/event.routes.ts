...
router.post(
  "/:id/join",
  authMiddleware,
  async (req, res) => await EventController.joinEvent(req, res)
);

router.post(
  "/:id/leave",
  authMiddleware,
  async (req, res) => await EventController.leaveEvent(req, res)
);
...
router.get(
  "/:id/comments",
  authMiddleware,
  asyncHandler(EventController.getCommentsToEvent)
);
router.post(
  "/:id/comments",
  authMiddleware,
  asyncHandler(CommentController.addCommentToEvent)
);
...
router.post(
  "/recommend",
  authMiddleware,
  async (req, res) => await EventController.recommendEvents(req, res)
);
